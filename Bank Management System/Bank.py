...
if __name__ == '__main__':
    ...
    cust1 = BankAccount(name='Muzamil', mobile_no=9876543210, initial_depo=1000, pin=123)
    cust2 = BankAccount(name='Zain', mobile_no=9876543212, initial_depo=2000, pin=456)
